...
export default function Demo() {
  ...
  const ProjectBox = ({ project }: { project: Project }) => (
    <div
      className={`group bg-white border-2 border-black rounded-2xl ${boxHoverStyle} mx-4`}
    >
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="px-6 py-3 border-2 border-green-500 text-green-700 font-medium hover:border-green-600 hover:bg-green-50 transition-all duration-200 flex items-center space-x-2 hover:ring-2 hover:ring-green-500 hover:ring-opacity-50 rounded-lg"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
              ...
              <button
                ...
                className="px-6 py-3 border-2 border-red-500 text-red-700 font-medium hover:border-red-600 hover:bg-red-50 transition-all duration-200 flex items-center space-x-2 hover:ring-2 hover:ring-red-500 hover:ring-opacity-50 rounded-lg"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {selectedImage && (
        ...
        >
          <div
            className="relative max-w-4xl max-h-96 w-full"
          ...
          >
            ...
            {!loading && projects.length === 0 && (
              <div className="flex flex-col items-center justify-center py-32 text-center">
                <div className="mb-6 relative">
                  ...
                  <svg
                    className="w-24 h-24 text-blue-300 relative"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            {!loading && projects.length > 0 && (
              <div>
                <div className="mb-8">
                  <h2 className="text-5xl font-bold text-black mb-2">Demo</h2>
                ...
                <div className="space-y-8">
                  {projects.map((project, index) => (
                    <div
                      key={project._id}
                      className="mx-4 border-2 border-gray-300 rounded-2xl bg-white shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 p-6"
                    >
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {/* 이미지 */}
                        <div
                          className="lg:col-span-1 relative h-64 lg:h-80 rounded-xl overflow-hidden bg-gray-100 flex-shrink-0 cursor-pointer group"
                          onClick={() => setSelectedImage(project.imgSrc)}
                        >
                          <Image
                            src={project.imgSrc}
                        ...
                        <div className="lg:col-span-2 flex flex-col justify-between">
                          ...
                          <div className="flex flex-wrap gap-3 pt-6">
                            <Link
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-200 flex items-center space-x-2 hover:shadow-lg"
                            >
                              <span>데모 보기</span>
                              <svg
                                className="w-4 h-4"
                            ...
                            <Link
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 flex items-center space-x-2 hover:shadow-lg"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="currentColor"
                            ...
                            <Link
                              href={`/demo/edit/${project._id}`}
                              className="px-6 py-3 border-2 border-green-500 text-green-700 font-semibold rounded-lg hover:border-green-600 hover:bg-green-50 transition-all duration-200 flex items-center space-x-2 hover:shadow-lg"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
                            ...
                            <button
                              onClick={() => handleDelete(project._id)}
                              className="px-6 py-3 border-2 border-red-500 text-red-700 font-semibold rounded-lg hover:border-red-600 hover:bg-red-50 transition-all duration-200 flex items-center space-x-2 hover:shadow-lg"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
