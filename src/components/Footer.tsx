...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-black z-40 py-3 shadow-lg">
        ...
        <div className="flex justify-center">
          ...
          <div className="flex gap-4">
            <Link
              ...
              className="w-8 h-8 rounded-full border border-gray-400 flex items-center justify-center hover:bg-gray-200 hover:border-gray-600 transition-colors"
              aria-label="GitHub"
            >
